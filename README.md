...
To run the project you need to have a backend part up and running locally. You can clone a backend part from https://github.com/ndrsonya/bloglist-backend
## Login credentials
